...
void UFriendWidgetBase::OnSendInputFriendButton()
{
	...
	ckFriend.set_mynickname(std::string(TCHAR_TO_ANSI(*Cast<UTrapperGameInstance>(GetGameInstance())->GetPlayerNickname())));
	ckFriend.set_requestnickname(std::string(TCHAR_TO_ANSI(*FNickname)));
