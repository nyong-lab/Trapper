...
class S_ADD_FRIEND final :
 ...
 public:
  ...
  public:
  void clear_friend_();
  const ::Protocol::UserInfo& friend_() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::Protocol::UserInfo* release_friend_();
  ::Protocol::UserInfo* mutable_friend_();
  void set_allocated_friend_(::Protocol::UserInfo* friend_);
  private:
  const ::Protocol::UserInfo& _internal_friend_() const;
  ::Protocol::UserInfo* _internal_mutable_friend_();
  public:
  void unsafe_arena_set_allocated_friend_(
      ::Protocol::UserInfo* friend_);
  ::Protocol::UserInfo* unsafe_arena_release_friend_();
...
// .Protocol.UserInfo friend = 1;
inline bool S_ADD_FRIEND::_internal_has_friend_() const {
  return this != internal_default_instance() && friend__ != nullptr;
}
inline bool S_ADD_FRIEND::has_friend_() const {
  return _internal_has_friend_();
}
inline const ::Protocol::UserInfo& S_ADD_FRIEND::_internal_friend_() const {
  const ::Protocol::UserInfo* p = friend__;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::UserInfo&>(
      ::Protocol::_UserInfo_default_instance_);
}
inline const ::Protocol::UserInfo& S_ADD_FRIEND::friend_() const {
  // @@protoc_insertion_point(field_get:Protocol.S_ADD_FRIEND.friend)
  return _internal_friend_();
}
inline void S_ADD_FRIEND::unsafe_arena_set_allocated_friend_(
    ::Protocol::UserInfo* friend_) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.S_ADD_FRIEND.friend)
}
inline ::Protocol::UserInfo* S_ADD_FRIEND::release_friend_() {
  
  ::Protocol::UserInfo* temp = friend__;
  friend__ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::Protocol::UserInfo* S_ADD_FRIEND::unsafe_arena_release_friend_() {
  // @@protoc_insertion_point(field_release:Protocol.S_ADD_FRIEND.friend)
  
  ::Protocol::UserInfo* temp = friend__;
  friend__ = nullptr;
  return temp;
}
inline ::Protocol::UserInfo* S_ADD_FRIEND::_internal_mutable_friend_() {
...
inline ::Protocol::UserInfo* S_ADD_FRIEND::mutable_friend_() {
  // @@protoc_insertion_point(field_mutable:Protocol.S_ADD_FRIEND.friend)
  return _internal_mutable_friend_();
}
inline void S_ADD_FRIEND::set_allocated_friend_(::Protocol::UserInfo* friend_) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(friend__);
  }
  ...
  friend__ = friend_;
  // @@protoc_insertion_point(field_set_allocated:Protocol.S_ADD_FRIEND.friend)
}
